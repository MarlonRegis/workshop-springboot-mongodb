package com.marlonregis.demo.config;
...
import com.marlonregis.demo.DTO.AuthorDTO;
import com.marlonregis.demo.DTO.CommentDTO;
...
import com.marlonregis.demo.repository.UserRepository;
...
public class Instantiation implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		Post post2 = new Post(null, sdf.parse("23/03/2018"), "Bom dia", "Acordei feliz hoje!o", mariaDTO);
